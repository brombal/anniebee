...
sub PrintItemList() {
  ...
  $itemlist = "$itemlist\n\n<form action=\"$FILENAME\" method=\"post\">\n<font size=3><b>Choose an item, or click \"Add\" to create a new one.</b></font><p>\n\n<table border=0 cellpadding=10 cellspacing=0><tr valign=\"top\">\n<td>\n<select name=\"item\" size=7>";
  ...
  $itemlist = "$itemlist\n</select>\n</td>\n<td><input type=\"image\" src=\"images/edit.gif\" name=\"edit\"><br>\n<input type=\"image\" src=\"images/delete.gif\" name=\"delete\"><br>\n<input type=\"image\" src=\"images/add.gif\" name=\"add\"><br>\n</td></tr></table><p>\n\n<input type=\"image\" name=\"list\" src=\"images/list.gif\"><img src=\"$DIR" . "px.gif\" height=1 width=10><input type=\"image\" name=\"view\" src=\"images/view.gif\">\n</form>\n\n<center><img src=\"$DIR" . "line.jpg\"></center><p>";
...
sub PrintItemInfo {
  ...
  $iteminfo = "$iteminfo\n  <td><center><font face=\"verdana\" size=2>Text Below Images</font><p><img src=\"images/style1.gif\"><br><input type=\"radio\" name=\"style\" value=\"1\"$ch1></center></td>\n  <td><center><font face=\"verdana\" size=2>Text Above Images</font><p><img src=\"images/style2.gif\"><br><input type=\"radio\" name=\"style\" value=\"2\"$ch2></center></td>\n </tr></table>\n <input type=\"hidden\" name=\"mainact\" value=\"$mainact\">\n";
...
sub PrintFooter {
  my($footer) = "\n\n</td></tr>\n</table>\n\n<center><img src=\"$DIR" . "px.gif\" height=\"20\"><br clear=\"all\"><a href=\"$DIR" . "home.html\"><img src=\"$DIR" . "home.gif\" border=\"0\"></a></center>\n\n</body></html>";
  return $footer;
}
